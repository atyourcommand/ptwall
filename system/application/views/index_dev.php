      ...
      <? } else {	?>
       ...
       <!--search code start here-->
        <form name="test_form" id="additional_search_form" action="<?php echo base_url(); ?>index.php?c=welcome&m=index" method="post">
      	...
      	<h1 class="hero center">They do the Personal Training. We do the Tweeting! hasan</h1>
          ...
          <form name="extra_test_form" id="function_search_form" action="<?php echo base_url(); ?>index.php?c=welcome&m=index" method="post">
            <div class="inputs row-fluid">
              ...
              <label for="country" class="span4" ><span style="display:none;">Choose country</span>
          			<?php  echo form_dropdown('country', $country_list,$country,'id=country onChange="clearSearch(); onChangeAjax();" '); ?>
          		</label>
              <label for="state" class="span4"><span style="display:none;">Choose state</span> <?php echo form_dropdown('state', $state_list,$state_selected,'id=state onChange="clearSearch(); onChangeAjax();" class='); ?> </label>
              <label for="region" class="span4"><span style="display:none;">Choose County</span> <?php echo form_dropdown('county', $county_list, $county_selected,'id=county  onChange=clearSearch(); onChangeAjax()'); ?> </label>
            ...
            <label for="specialities" class="lbl_sm" id="sort_criteria" style="text-indent:-2000px;display: none;"><span style="display:none;">Choose </span><?php echo form_dropdown('sort_options', $sort_options, $sort_options_selected,'class=slt_sm onChange= clearSearch(); onChangeAjax()'); ?> </label>
            <?} else { ?>
            <label for="specialities" class="lbl_sm" id="sort_criteria" style="text-indent:-2000px;"><span style="display:none;">Choose </span><?php echo form_dropdown('sort_options', $sort_options, $sort_options_selected,'class=slt_sm onChange= clearSearch(); onChangeAjax()'); ?> </label>
            <? } ?> -->
              <label for="specialities" class="span4" id="sort_criteria"><span style="display:none;">Choose </span><?php echo form_dropdown('sort_options', $sort_options, $sort_options_selected,' onChange=clearSearch(); onChangeAjax()'); ?> </label>
