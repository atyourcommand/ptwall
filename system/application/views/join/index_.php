...
<div id="wrapper" class="container <?php if (strpos($_SERVER['HTTP_USER_AGENT'], 'iPhone') == TRUE) { ?>handheld<? } else {	?>screen<? } ?>">
  <div class="row-fluid">
    <div class="">
      ...
      <p class="marketing-byline center">Personal Trainers grab a free page and thousands of page visits every year </p>
  ...
  <hr class="soften">
  <div class="row-fluid">
    <div class="span4"> <img src="../images/glyphicons/glyphicons_332_certificate.png" class="bs-icon">
    ...
    <div class="span4"> <img src="../images/glyphicons/glyphicons_289_podium.png" class="bs-icon">
    ...
    <div class="span4"> <img src="../images/glyphicons/glyphicons_392_twitter.png" class="bs-icon">
