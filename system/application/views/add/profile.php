...
<form name="profile" action="index.php?c=add&m=profile" method="post">
  ...
  <h1 class="center"><small> Profile dashboard:  </small></h1>
    <p class="center"><strong><?php if($user->approved==0) { ?>
    <?php echo $user->first_name ?>, we can't wait to promote your links.
    <? } else { ?>
    ...
    <? } ?></strong>
 </p><div class="content-divider"></div>
  <?php if ($email_verified==0 && $user->active==1) { ?>
  <div class="alert-block alert-danger center">Your email address is not verified yet. If you did not receive the email with the verification link please <a href="mailto:admin@personaltrainerwall.com">email</a> us now.</div>
  <? } ?>
...
<section>
  <div class="row-fluid">
    <div class="span4">
      <p><strong>Choose or change your free account type</strong></p>
    </div>
    <div class="span8">
...
<?php if ($user->guest!=1) { ?>
  ...
  <div id="retweets1" class="row-fluid">
    <div class="well">
      <div class="span4">
        <p><strong>PT Auto Tweets</strong></p>
      </div>
      <div class="span8">
        <ul class="plain">
          <li>
            <label> <?php echo form_checkbox($show_retweets_chkbox); ?> <span><strong>Yes:</strong> Please add my data to the next Auto Tweets weekly list.</span> <a href="/retweets/" target="_blank">More info.</a></label>
          </li>
        </ul>
      </div>
    </div>
  </div>
  <!--<div id="apps1" class="row-fluid">
    <div class="well">
      <div class="span4">
...
<li class="expanders"> 
  <!----name location--->
  <div class="form-stacked noPad"> <a class="toggle" href="#">
      ...
      <li>
        <div class="clearfix row-fluid">
          <fieldset class="span3">
            <label for="firstName" class="lbl_med">First Name </label>
            <div class="input clearfix"> <?php echo form_input($first_name); ?> </div>
            <label for="lastName" class="lbl_med">Last Name </label>
          ...
          <fieldset class="span3">
            <label for="emailAddress" class="lbl_med">Email Address </label>
          ...
          <fieldset class="span3">
            <?php
		  		if (form_error('country')) $country_class = 'span12 error'; else $country_class = 'span12';
				if (form_error('state')) $state_class = 'span12 error'; else $state_class = 'span12';
				if (form_error('county')) $county_class = 'span12 error'; else $county_class = 'span12';
				if (form_error('city')) $city_class = 'span12 error'; else $city_class = 'span12';
		   ?>
            <label for="tag1" class="lbl_med">Country </label>
            ...
            <label for="tag2" class="lbl_med">State </label>
            ...
            <label for="tag3" class="lbl_med">County </label>
          ...
          <fieldset class="span3">
            <label for="tag3" class="lbl_med">City (USA Only) </label>
  ...
  <?php if ($user->guest!=1) { ?>
  <!----services--->
  <div class="form-stacked noPad" id="services1"><a class="toggle" href="#">
    <h3>Services</h3>
    </a>
    <ul>
      <li>
        <div class="clearfix row-fluid">
          <fieldset class="span3">
            <label for="tag1" class="lbl_med">Tag 1 </label>
            <div class="input clearfix"> <?php echo form_dropdown('tag[1]', $tag_special_menu,$tags[1],'class=span12 id=tag[1] onchange="updateTweet()"'); ?> </div>
            <label for="tag2" class="lbl_med">Tag 2 </label>
            <div class="input clearfix"> <?php echo form_dropdown('tag[2]', $tag_special_menu,$tags[2],'class=span12 id=tag[2] onchange="updateTweet()"'); ?> </div>
            <label for="tag3" class="lbl_med">Tag 3 </label>
            <div class="input clearfix"> <?php echo form_dropdown('tag[3]', $tag_special_menu,$tags[3],'class=span12 id=tag[3] onchange="updateTweet()"'); ?> </div>
          </fieldset>
          <fieldset class="span3">
            <label for="tag1" class="lbl_med">Tag 1 </label>
            <div class="input clearfix"><?php echo form_dropdown('tag[4]', $tag_sports_menu,$tags[4],'class=span12 id=tag[4] onchange="updateTweet()"'); ?> </div>
            <label for="tag2" class="lbl_med">Tag 2 </label>
            <div class="inputs clearfix"><?php echo form_dropdown('tag[5]', $tag_sports_menu,$tags[5],'class=span12 id=tag[5] onchange="updateTweet()"'); ?> </div>
            <label for="tag3" class="lbl_med">Tag 3 </label>
            <div class="input clearfix"><?php echo form_dropdown('tag[6]', $tag_sports_menu,$tags[6],'class=span12 id=tag[6] onchange="updateTweet()"'); ?> </div>
          </fieldset>
          <fieldset class="span3">
            <label for="tag1" class="lbl_med">Tag 1 </label>
            <div class="input clearfix"> <?php echo form_dropdown('tag[7]', $tag_style_menu,$tags[7],'class=span12 id=tag[7] onchange="updateTweet()"'); ?> </div>
            <label for="tag2" class="lbl_med">Tag 2 </label>
            <div class="input clearfix"> <?php echo form_dropdown('tag[8]', $tag_style_menu,$tags[8],'class=span12 id=tag[8] onchange="updateTweet()"'); ?> </div>
            <label for="tag3" class="lbl_med">Tag 3 </label>
            <div class="input clearfix"> <?php echo form_dropdown('tag[9]', $tag_style_menu,$tags[9],'class=span12 id=tag[9] onchange="updateTweet()"'); ?> </div>
          </fieldset>
          <fieldset class="span3">
            <label for="organization" class="lbl_med">Accredited Orgs </label>
            <div class="input clearfix"> <?php echo form_dropdown('training_org', $training_org_menu,$training_org_sel,'class=span12'); ?> </div>
            <label for="certification" class="lbl_med">Certification </label>
            <div class="input clearfix"> <?php echo form_dropdown('certificate', $certificate_menu,$certificate_sel,'class=span12'); ?> </div>
            <label for="regNo" class="lbl_med">Reg No <a href="<?php echo base_url(); ?>info/approve-trainers-page.php" rel="facebox">Certification Tips</a></label>
            <div class="input clearfix"> <?php echo form_input($cert_reg_no); ?> </div>
            <label for="expDate" class="lbl_sm">Exp Date </label>
            <div class="input clearfix"> 
  ...
  <?php if (($user->guest!=1) || ($user->guest==1 && $user->sponsor==1 )) { ?>
            ...
            <div class="form-stacked noPad" id="more1" > <a class="toggle" href="#">
              <h3>More</h3>
              </a>
              <ul>
                <li>
                  <div class="clearfix row-fluid">
                    ...
                    <fieldset class="span3">
                    <label for="emailAddress" class="lbl_med">Phone Number </label>
                    <div class="inputs"> <?php echo form_input($phone_no); ?> </div>
                    <label for="phoneShow" class="lbl_sm"> Hide Phone </label>
                    <div class="inputs clearfix"> <?php echo form_checkbox($hide_phone_chkbox); ?> </div>
                    <label for="businessName" class="lbl_med">Business Name (sponsors only) </label>
                    <div class="inputs clearfix"> <?php echo form_input($business_name); ?> </div>
                    </fieldset>
                    <fieldset class="span3">
                    <label for="facebookLink" class="lbl_med">Additional Facebook URL </label>
                    <div class="inputs clearfix"><?php echo form_input($facebook_url); ?> </div>
                    <label for="myspaceLink" class="lbl_med">My Workplace URL </label>
                    <div class="inputs clearfix"><?php echo form_input($workplace_url); ?> </div>
                    <span class="help-block">The http:// is not required here</span>
                    <label for="linkedinLink" class="lbl_med">Linkedin URL </label>
                    <div class="inputs clearfix"> <?php echo form_input($linkedin_url); ?> </div>
                 <!--   <span class="help-block">The http:// is not required</span>-->
                    </fieldset>
                    
                    <fieldset class="span3">
                    <label for="street_address" class="lbl_med">Street address </label>
                    <div class="inputs clearfix"> <?php echo form_input($street_address); ?> </div>
                    <label for="mapShow" class="lbl_sm"> Hide Google Map </label>
                    <div class="inputs clearfix"> <?php echo form_checkbox($hide_google_map_chkbox); ?> </div>
                    </fieldset>
                  </div>
                </li>
              </ul>
            ...
            <div class="form-stacked noPad" id="message1"> <a class="toggle" href="#">
              <h3>Message</h3>
              </a>
              <ul>
                <li>
                  <div class="clearfix">
                    ...
                    <div class="inputs clearfix">
                      <textarea name="description" id="description" class="span6" cols="4" rows="4" onKeyDown="limitText(this.form.description,this.form.countdown,500);" onKeyUp="limitText(this.form.description,this.form.countdown,500);"><?php echo $description ?></textarea>
                    </div>
                    </fieldset>
                  </div>
                </li>
            ...
            <!-- error in fields -->
            <!-- end error in fields -->
            <div class="well"><span class="btn-std alt">
              <!--<input type="submit" name="submit" value="Update Profile!" class="btn-std" />-->
              <input type="submit" onClick="ShowProgress('Updating profile, please wait...');" name="submit" value="Update Profile" class="btn-std" />
