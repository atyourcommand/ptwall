        ...
        <div id="demo_area" class="clearfix">
          ...
          <div id="right_col" style="float:left;width:500px">
            ...
            <p style="font-size:13px";>Close ups are great, need the face and not the kids this time.<br>
              ...
              <a href="mailto:admin@personaltrainerwall.com?subject=Message about adding my Image ">Email us</a> if you need any assistance or have a question about your image.<br/>
            </p>
          </div>
          <div class="clear"> </div>
        </div>
