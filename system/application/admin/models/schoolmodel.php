...
/**
 * MODULE NAME   : schoolmodel.php
 *
 * DESCRIPTION   : School model controller
 *
 * MODIFICATION HISTORY
 *   V1.0   2009-11-22 07:52 AM   - Pradesh Chanderpaul     - Created
 *
 * @package             school
 * @subpackage          School model component Class
...
//      return $this->find(array('college_id' => '$key_value'));
//   }
   ...
   function find($filters = NULL, $start = NULL, $count = NULL) {
      ...
      // ///////////////////////////////////////////////////////////////////////
      $this->table_record_count = $this->db->count_all( 'school' );
      ...
      $sql = 'SELECT * FROM school ' . $where_clause . $limit_clause;
      ...
      if ($query->num_rows() > 0) {
         ...
         foreach ($query->result_array() as $row)      // Go through the result set
         {
			...
			$query_results['college_id']		 = $row['college_id'];
   ...
   function retrieve_by_pkey($idField) {
      ...
      $query = $this->db->query("SELECT * FROM school WHERE college_id = '$idField' LIMIT 1");
   ...
   function add( $data ) {
      ...
      $sql = $this->db->insert_string('school', $data);
   ...
   function modify($keyvalue, $data) {
      ...
      // Build up the SQL query string
      $where = "college_id = $keyvalue";
      $sql = $this->db->update_string('school', $data, $where);
   ...
   function delete_by_pkey($idField)
   {
      ...
      // ///////////////////////////////////////////////////////////////////////
      // $query = $this->db->query("DELETE FROM school WHERE college_id = '$idField' ");
	...
	function set_College_id($college_id) {
