<?php /* Smarty version 2.6.2, created on 2010-09-17 07:11:53
         compiled from thanks.html */ ?>
<?php require_once(_SMARTY_DIR . 'core' . DIRECTORY_SEPARATOR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'thanks.html', 12, false),)), $this); ?>
<?php $this->assign('title', @constant('_TPL_THX_TITLE')); ?>
...
<?php if ($this->_tpl_vars['config']['google_analytics']): ?>
<?php $_smarty_tpl_vars = $this->_tpl_vars;
