...
class payment_authorize_cim extends payment {
    ...
    ***************************************************************/
    ...
    function save_cc_info($cc_info, & $member) {
        ...
        $hash = md5("$cc_info[cc_number]:$cc_info[cc_expire]:$cc_info[cc_name_f]:$cc_info[cc_name_l]:$cc_info[cc_country]:$cc_info[cc_state]:$cc_info[cc_city]:$cc_info[cc_street]:$cc_info[cc_zip]:$cc_info[cc_phone]");
